...
<body>
	...
	<p>Dans un deuxième temps, la sécurité d'un site est à la charge de ceux qui l'ont conçu. Il faut que le site respecte plusieurs règles au niveau des cookies (chiffre les cookies, utiliser des protocoles HTTPS, utiliser un ID de session aléatoire, ...).</p>
	<br/>
